...
public interface IMapping<T> {
    /**
     * Maps data in item to a {@link net.daverix.snakedb.mapping.IInsertableValues} object.
     * @param item the item with data
     * @throws net.daverix.snakedb.exception.FieldNotFoundException when field can't be found in values
     */
