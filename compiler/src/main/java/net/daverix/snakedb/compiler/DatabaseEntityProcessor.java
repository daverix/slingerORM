package net.daverix.snakedb.compiler;
 ...
 * //TODO: look for fields in inherited classes
 */
@SupportedAnnotationTypes("net.daverix.snakedb.annotation.DatabaseEntity")
    ...
    public boolean process(Set<? extends TypeElement> typeElements, RoundEnvironment roundEnvironment) {
        for (Element entity : roundEnvironment.getElementsAnnotatedWith(DatabaseEntity.class)) {
            try {
                ...
                processingEnv.getMessager().printMessage(Diagnostic.Kind.NOTE, "Generating " + entity.getSimpleName() + "Mapper");
